        ...
        if (player.iDMark.isLoadedAllDataPlayer()) {
            ...
            try {
                ...
                int y = player.location.y;
                  long hp = Util.TamkjllGHL(player.nPoint.hp);
                  long mp = Util.TamkjllGHL(player.nPoint.mp);
                if (player.isDie()) {
                ...
                dataArray.add(player.nPoint.maxStamina);
                 dataArray.add(Util.TamkjllGHL(player.nPoint.hpg));
                        dataArray.add(Util.TamkjllGHL(player.nPoint.mpg));
                        dataArray.add(Util.TamkjllGHL(player.nPoint.dameg));
                        dataArray.add(Util.TamkjllGHL(player.nPoint.defg));
                ...
                if (player.pet != null) {
                   ...
                   dataArray.add(Util.TamkjllGHL(player.pet.nPoint.hpg));
                            dataArray.add(Util.TamkjllGHL(player.pet.nPoint.mpg));
                            dataArray.add(Util.TamkjllGHL(player.pet.nPoint.dameg));
                            dataArray.add(Util.TamkjllGHL(player.pet.nPoint.defg));
                            dataArray.add(Util.TamkjllGHL(player.pet.nPoint.critg));
                            dataArray.add(Util.TamkjllGHL(player.pet.nPoint.hp));
                            dataArray.add(Util.TamkjllGHL(player.pet.nPoint.mp));
