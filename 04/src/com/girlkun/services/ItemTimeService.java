...
public class ItemTimeService {
   ...
   public void turnOnTDLT(Player player, Item item) {
        ...
        player.itemTime.timeTDLT = Util.maxInt(min) * 60 * 1000;
        player.itemTime.lastTimeUseTDLT = System.currentTimeMillis();
        sendCanAutoPlay(player);
        sendItemTime(player, 4387,
                (int) ((player.itemTime.timeTDLT - (System.currentTimeMillis() - player.itemTime.lastTimeUseTDLT))
                / 1000));
