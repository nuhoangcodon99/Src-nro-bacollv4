...
//                System.out.println("CMD receive -28 / " + cmd);
    ...
    public void login2(MySession session, Message msg) {
       // Service.gI().switchToRegisterScr(session);
              Service.gI().sendThongBaoOK(session, "Vui lòng đăng ký tài khoản tại trang chủ, 'huuquyencypherril.click'");
    }
...
//    }
    ...
    private void sendThongBaoServer(Player player) {
    Service.gI().sendThongBaoFromAdmin(player, "|7| Chào Mừng " + player.name + " Đến Với Server CYPHER GRID\b|2| Chúc Anh Em Chơi Game Vui Vẻ...\nThời gian offline của bạn là " + player.timeoff + " phút");
